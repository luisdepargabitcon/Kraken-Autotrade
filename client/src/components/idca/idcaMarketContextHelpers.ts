...
export type VwapZone = "below_lower3" | "below_lower2" | "below_lower1" | "between_bands" | "above_upper1" | "above_upper2" | "above_upper3";
...
export function getZoneExplanation(zone?: VwapZone | string): ZoneExplanation {
  switch (zone) {
    case "below_lower3":
      return {
