 ...
 * No parameter selection. Outputs STACKING_HISTORICAL_CONTROL.csv.
 *
...
const OUT_DIR = path.join(
  ...
  "docs", "auditoria", "spot-forward-2026-09-20",
);
...
async function main() {
  ...
  fs.writeFileSync(path.join(OUT_DIR, "STACKING_HISTORICAL_CONTROL.csv"), rows.join("\n"));
  console.log(`OUT=${path.join(OUT_DIR, "STACKING_HISTORICAL_CONTROL.csv")}`);
}
