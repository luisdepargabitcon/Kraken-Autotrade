/**
 * downloadTradesData.ts â€” Downloads historical trades from Kraken REST API
...
// â”€â”€â”€ Fetch with retry â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  for (let attempt = 0; attempt < MAX_RETRIES; attempt++) {
    try {
      ...
      if (resp.status === 429 || resp.status >= 500) {
        ...
        console.log(`  [Trades] ${resp.status} â€” retry in ${backoff}ms (attempt ${attempt + 1}/${MAX_RETRIES})`);
        await sleep(backoff);
        continue;
      }
      ...
      const backoff = Math.min(1000 * Math.pow(2, attempt), 30000);
      console.log(`  [Trades] Error: ${(e as Error).message} â€” retry in ${backoff}ms (attempt ${attempt + 1}/${MAX_RETRIES})`);
      await sleep(backoff);
    }
  }
...
// â”€â”€â”€ Candle aggregation â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Checkpoint â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Download pair â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
async function downloadPairTrades(
  ...
  console.log(`[Trades] ${mapping.requested}: done â€” ${tradeCount} trades, ${requestCount} requests`);
}
...
async function main() {
  ...
  for (const mapping of PAIR_MAPPINGS) {
    for (const tf of TIMEFRAMES) {
      ...
      console.log(`  ${mapping.requested} ${tf}m: ${ds.rowCount} candles, ${days.toFixed(1)} days, ${ds.firstTimestamp > 0 ? new Date(ds.firstTimestamp).toISOString() : "N/A"} â†’ ${ds.lastTimestamp > 0 ? new Date(ds.lastTimestamp).toISOString() : "N/A"}`);
    }
  }
}
