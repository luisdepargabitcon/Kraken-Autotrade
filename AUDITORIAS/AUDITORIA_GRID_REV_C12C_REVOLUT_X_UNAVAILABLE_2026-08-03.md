...
## 12. Integracion en main y deploy staging (2026-08-04)

- MAIN_PREVIOUS_SHA = 44cd46ff3a6e195556987968a87c8e795d66cd02
- DEPLOYED_CODE_SHA = 8d5617fd0022be378d13b6c4ba9a523025057314
- MERGE_METHOD = FAST_FORWARD, COMMITS_INTEGRATED = 24, MERGE_COMMIT_CREATED = FALSE
- VPS = root@5.250.184.18, ENVIRONMENT = STAGING
- PRE_DEPLOY_SHA = 24518a1af91ddc64b338fffc3b250bf1414a72ec
- APP_STATE = running, ROLLBACK_IMAGE_ONLY = FALSE
- DB_RESTARTED = FALSE, SQL_EXECUTED = FALSE, MIGRATIONS_EXECUTED = FALSE
- MODE_AFTER = SHADOW, MARKET_DATA_SOURCE = KRAKEN_MARKET_DATA
- EXECUTION_VENUE = REVOLUT_X, EXECUTION_POLICY = MAKER_ONLY
- EFFECTIVE_TAKER_FALLBACK_ALLOWED = FALSE, TAKER_FALLBACK_USED = FALSE
- REAL_OPEN_ORDERS_COUNT = 0, FATAL_ERRORS = 0
- REVOLUT_X_CONSTRAINTS_UNAVAILABLE persiste en staging: FAIL_CLOSED_EXPECTED.
- Proxima fase: REV-C12F — diagnostico read-only de constraints Revolut X.
- DONE = TRUE, REV-C12E_COMPLETADA = TRUE.
