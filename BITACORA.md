...
- **Tests**: 33 tests nuevos en `revolutXPairConstraintsSchema.test.ts` (19 helper + 14 integración). 105 tests Grid relacionados pasados. 15 tests existentes de `revolutXPairConstraints.test.ts` pasados. CHECK_EXIT=0, BUILD_EXIT=0, DIFF_EXIT=0.
...
- **Estado**: DONE=FALSE, HARD_BLOCKER=FALSE. TASK_STATUS=REV-C12F corregida tras verificación independiente; pendiente commit y nueva verificación. NEXT_ACTION=verificar commits y autorizar fast-forward.
